		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form:form method="post" modelAttribute="insert_annuncio_attr" action="save" novalidate="novalidate" >
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<spring:bind path="testoAnnuncio">
									<input type="text" name="testoAnnuncio" id="testoAnnuncio" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il Testo Annuncio" value="${edit_annuncio_attr.testoAnnuncio }">
								</spring:bind>
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="prezzo">
									<input type="number" name="prezzo" id="prezzo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il prezzo" value="${edit_annuncio_attr.prezzo }">
								</spring:bind>
						...
						<div class="form-row">	
							<div class="form-group col-md-6">	
									<label for="categorie">Categorie:</label>
										...
										<c:forEach items="${edit_annuncio_attr}" var="categoriaItem">
						...
						<div class="form-row">	
							<div class="form-group col-md-6">	
								<label class ="form-check-inline" for="${edit_annuncio_attr.aperto}">Annuncio: </label>
							 		Aperto
	  								<input class="form-check-input" type="radio" name="aperto" id="aperto" value="${edit_annuncio_attr.aperto}true" >
	  								Chiuso
	  								<input class="form-check-input" type="radio" name="aperto" id="aperto" value="${edit_annuncio_attr.aperto}false" >
  							</div>
							</div>
						</div>
						<div class="form-row">
						    <div class="form-group col-md-6">
									<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${edit_annuncio_attr.dataPubblicazione}' />
