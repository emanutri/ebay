		...
		<main role="main" class="container">
			...
			<div class='card'>
			    ...
			    <div class='card-body'>
						...
						<form:form modelAttribute="insert_utente_attr" method="post" action="save" novalidate="novalidate" >
						...
						<div class="form-row">
							...
							<div class="form-row">	
								...
								<div class="form-group col-md-6">
									...
									<spring:bind path="password">
										<input type="password" class="form-control ${status.error ? 'is-invalid' : ''}" autocomplete="new-password" name="password" id="password" placeholder="Inserire password" value="${insert_utente_attr.password }" required>
									</spring:bind>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									...
									<spring:bind path="codiceFiscale">
										<input type="text" name="codiceFiscale" id="codiceFiscale" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il codice fiscale" value="${insert_utente_attr.codiceFiscale }" required>
									</spring:bind>
			       		...
			       		<div class="form-row">
			       			<div class="form-group col-md-6">
									<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${insert_utente_attr.dataNascita}' />
