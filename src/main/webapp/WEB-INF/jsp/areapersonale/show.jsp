		    ...
		    <div class='card-body'>
	            ...
	            <div class="collapse" id="collapseAnnunci">
	                <div class="card card-body">
						...
						<a href="${pageContext.request.contextPath }/areapersonale/showInfoAnnuncio/${annuncioItem.id}" class='btn btn-outline-primary btn-sm'>
				            <i class='fa fa-chevron-left'></i> Visualizza Dettagli
				        </a>
				...
				<c:forEach var = "acquistoItem" items = "${show_utente_attr.acquisti }">
					<div class="collapse" id="collapseAcquisti">
					  <div class="card card-body">
						...
						<a href="${pageContext.request.contextPath }/areapersonale/showInfoAcquisto/${acquistoItem.id}" class='btn btn-outline-primary btn-sm'>
				            <i class='fa fa-chevron-left'></i> Visualizza Dettagli
				        </a>
